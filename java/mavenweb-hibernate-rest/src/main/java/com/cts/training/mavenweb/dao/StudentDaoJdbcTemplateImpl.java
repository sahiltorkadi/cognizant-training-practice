...
public class ProductDaoJdbcTemplateImpl implements IProductDao {
	...
	private final String SQL_INSERT = "insert into product(name,cost) values(?, ?)";
	private final String SQL_UPDATE = "update product set name=?, cost=? where id=?";
	...
	public boolean add(Product product
		// TODO Auto-generated method stub
		int n = this.jdbcTemplate.update(this.SQL_INSERT, new Object[] {product.getName(), product.getCost;
	...
	public boolean updateProduct product
		// TODO Auto-generated method stub
		int n = this.jdbcTemplate.update(this.SQL_UPDATE, new Object[] {product.getName(), product.getCost(), product.getId()});
		// n : number of rows affected
		if(n>0)
			return true;
		return false;
